...
- **E1** No PTS on the wire; decoder stamps frames with the local host clock on arrival ([Sidewire/Media/VideoDecoder.swift:187](../Sidewire/Media/VideoDecoder.swift)). Phase 7 adds a wire PTS.
